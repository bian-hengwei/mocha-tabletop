...
| 游戏 | 人数 | 玩法 |
| --- | --- | --- |
| 斗地主 | 3 | 经典叫分、完整基础牌型、炸弹与春天计分 |
| 掼蛋 | 4 | 双副牌对家、逢人配、牌型宣告、进还贡与 2 到 A 升级赛 |
| 麻将 | 4 | 广东推倒胡、四川血战、血流成河、红中赖子 |
| 晶石商会 | 2–4 | 收集宝石、购买发展卡、争取贵族 |
| 喵喵危机 | 2–5 | 抽牌、出牌和拆弹，生存到最后 |
| 月夜议会 | 6–18 | 三种主持模式；九人预女猎、十二人预女猎白／守、狼王守卫及灵活人数配置 |
...
| 单人人机 | 首次加载并完成缓存后可离线 | 选择总人数与统一难度，一位真人对阵其余人机 |
| 同屏试玩 | 首次加载并完成缓存后可离线 | 一台设备切换座位，熟悉规则和操作 |

单机开局前可选择总人数，固定人数玩法按规则显示。八款非自由交流游戏支持单人人机；同屏试玩可切换座位，不是隐藏身份的多人房间。局域网模式没有 TURN 中继，访客 Wi-Fi 的设备隔离等限制可能使直连失败，此时可以使用云端房间。

## 本机记忆与恢复

昵称、头像使用已有的本地存储，下次打开无需重填。个人战绩自动保存已收到的终局结果（最多 500 局），支持单条删除、全部删除；单人人机、同屏试玩和法官主持单独标记，不计入个人联机胜负。删除后重新打开终局不会重复添加。

关闭网页后，在同一浏览器重新打开可自动恢复尚未过期的房间；首页也提供恢复入口。云端牌局由服务端保存，局域网房主的牌局在本机保存。单人人机和同屏试玩也可恢复，保存期限为 7 天；单人人机保留人数、难度及规则。主动离开、房主解散、房间过期或清理本机数据后无法恢复。浏览器与主屏幕 App 可能使用不同存储空间，恢复和战绩不跨设备同步。
