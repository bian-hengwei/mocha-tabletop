...
function initial(){const mode=(params.get('mode')||'guangdong') as MahjongMode,s=mahjong.create(players,11,{mahjongMode:mode});if(scenario==='opening')return s;s.phase='discard';if(mode==='sichuan'||mode==='bloodflow')s.missing={0:2,1:2,2:2,3:2};
