...
const totals={sushi:[22,20,25,24,25],century:[15,20,31,16,27],uno:[120,310,530,99,400,210,111,97,55,8]};
try{
 for(const locale of ['zh','en'])for(const kind of ['sushi','century','uno']){
