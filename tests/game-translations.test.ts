...
describe('engine translation coverage',()=>{
 it.each([
  ...
  ['0 分','0 points'],['1 分','1 point'],['2 分','2 points'],
  ['蓝宝石矿场 · 0 分','Sapphire Mine · 0 points'],['蓝宝石矿场 · 1 分','Sapphire Mine · 1 point'],['蓝宝石矿场 · 2 分','Sapphire Mine · 2 points'],
 ...
 it('translates nested card names and choices while preserving player names exactly',()=>{expect(translate('狼人 购买 蓝宝石矿场 · 1 分')).toBe('狼人 purchased Sapphire Mine · 1 point');expect(translate('法官 打出 拆弹')).toBe('法官 played Defuse');expect(translate('狼人 已出牌')).toBe('狼人 played');expect(translate('预言家 · 攻击 · 已暂停')).toBe('预言家 · Attack · Stopped');expect(translate('预言家 · 攻击 · 已被否决')).toBe('预言家 · Attack · Blocked');expect(translate('狼人 · 2 张同名组合 · 已被否决')).toBe('狼人 · 2 matching cards · Blocked');expect(translate('表决：甲 赞成；乙 反对')).toBe('Votes: 甲: Approve; 乙: Reject');expect(translate('第 2 夜查验：狼人 · 好人')).toBe('Night 2 check: 狼人 · Council');});
