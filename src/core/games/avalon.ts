import { action, assertPlayers, seeded, shuffle, validateCommand, type GameModule, type Player, type GameView } from '../types';
...
export interface AvalonState {
  ...
  rejections:number; publicVotes:Record<string,boolean>; winner:string|null; log:string[];
}
