export const classicText:Record<string,string>={
 ...
 '公共牌池':'Public tiles','抢杠响应':'Robbing a kong','最新打出':'Latest discard','红中可代替任意牌；不能碰杠红中':'Red dragons are wild; no pung or kong on red dragons','牌河':'Discards','副露':'Meld','我的手牌':'My hand','同花色三张':'Three tiles of one suit','选择还贡牌':'Choose a return card','选牌后确认':'Select, then confirm','已选':'Selected','可以确认':'Ready to confirm','请调整选牌':'Adjust your selection','确认换牌':'Confirm exchange','确认还贡':'Return card','无可压过的牌':'No higher play','清空选择':'Clear selection','血流继续：手牌已锁定，只打新摸牌，可再次胡牌':'Blood Flow continues: hand locked; discard only the drawn tile and win again later','胡牌记录':'Win history'
};
