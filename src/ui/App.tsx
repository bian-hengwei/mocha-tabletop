...
export function App() {
    ...
    const coverArt = (k: GameKind) => { const index = ['sushi', 'century', 'uno', 'codenames', 'undercover'].indexOf(k); return index < 0 ? <img src={'/art/' + k + '.jpg'} alt=""/> : <IllustratedTile kind="covers" index={index} fit="slice" className="cover-painting"/>; };
