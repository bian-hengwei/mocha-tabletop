...
export function NewGamesTable(props: Props) { return props.view.finished?<NewGameResults view={props.view} selfID={props.selfID}/>:props.view.kind === 'sushi' ? <SushiTable {...props}/> : props.view.kind === 'uno' ? <UnoTable {...props}/> : <CenturyTable {...props}/>; }
