...
function Fixture(){
 const [s,setS]=useState<any>(()=>module.create(players,111,{werewolfMode:mode as GameOptions['werewolfMode'],moderatorID:'p0'})),[viewer,setViewer]=useState('p0'),[selection,setSelection]=useState<{a:Action;values:string[]}|null>(null);
